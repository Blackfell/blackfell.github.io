...
In this post I'll be taking you through some of the important weaknesses and considerations around passphrases and in later parts I'll explain what you can do to cut through the noise of advice and get a simple plan to get over the password problem.
...
For example, [Facebook has stated](https://www.facebook.com/notes/protect-the-graph/keeping-passwords-secure/1519937431579736?_fb_noscript=1){:target="_blank"} that instead of storing users passphrases, they store a [passphrase hash](https://www.maketecheasier.com/what-is-password-hashing/){:target="_blank"}, which is basically a way of verifying that you know a passphrase without having to store the actual value.
