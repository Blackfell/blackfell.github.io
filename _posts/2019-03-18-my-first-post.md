...
{% include figure image_path="/assets/images/posts/first_post/markdown.jpg" alt="Markdown rendering photo" caption="A sample of Markdown on the left, which I designed to build the [about](/about) page from this very website (on the right). Markdown was designed to let people structure content in a simple, effective way; software like Jekyllnow  allows markdown to be parsed and turned into styled HTML for web pages; this is very easy and a quick way to get content published." %}
