...
{% include figure image_path="/assets/images/posts/micro_lab/proxy-diag.png" alt="Web Proxy Diagram." caption="With one of our Web Testing proxies, your traffic doesn't go direct to the web; instead, your proxy accepts and forwards the traffic accordingly. This lets you inspect and manipulate requests as you see fit too." %}
